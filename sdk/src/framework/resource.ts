/**
 * @file    resource.ts
 * @brief   Global resources (singletons) for the ECS framework
 *
...
export class ResourceStorage {
    ...
    getRes<T>(resource: ResourceDef<T>): ResInstance<T> {
        return new ResInstance(this.get(resource));
    }
