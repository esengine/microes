...
const FlexContainerSchema: ComponentSchema = {
    ...
    properties: [
        ...
        { name: 'alignContent', type: 'enum', options: [{ label: 'Start', value: 0 }, { label: 'Center', value: 1 }, { label: 'End', value: 2 }, { label: 'Stretch', value: 3 }, { label: 'SpaceBetween', value: 4 }, { label: 'SpaceAround', value: 5 }] },
        { name: 'gap', type: 'vec2' },
...
const FlexItemSchema: ComponentSchema = {
    ...
    properties: [
        ...
        { name: 'alignSelf', type: 'enum', options: [{ label: 'Auto', value: 0 }, { label: 'Start', value: 1 }, { label: 'Center', value: 2 }, { label: 'End', value: 3 }, { label: 'Stretch', value: 4 }] },
        { name: 'margin', type: 'padding' },
        { name: 'minWidth', type: 'number', step: 1 },
        { name: 'minHeight', type: 'number', step: 1 },
        { name: 'maxWidth', type: 'number', step: 1 },
        { name: 'maxHeight', type: 'number', step: 1 },
        { name: 'widthPercent', type: 'number', step: 1, advanced: true },
        { name: 'heightPercent', type: 'number', step: 1, advanced: true },
    ],
};
