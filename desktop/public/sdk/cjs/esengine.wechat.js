...
function addSystem(system) {
    getPendingSystems().push({ schedule: exports.Schedule.Update, system });
}
function addStartupSystem(system) {
    getPendingSystems().push({ schedule: exports.Schedule.Startup, system });
}
...
const Material = {
    ...
    create(options) {
        ...
        const data = {
            ...
            uniforms: new Map(),
            blendMode: options.blendMode ?? exports.BlendMode.Normal,
    ...
    getBlendMode(material) {
        const data = materials.get(material);
        return data?.blendMode ?? exports.BlendMode.Normal;
    },
    /**
    ...
    createFromAsset(data, shaderHandle) {
        ...
        return this.create({
            shader: shaderHandle,
            uniforms,
            blendMode: data.blendMode ?? exports.BlendMode.Normal,
...
const Geometry = {
    ...
    createQuad(width = 1, height = 1) {
        ...
        return Geometry.create({
            ...
            layout: [
                { name: 'a_position', type: exports.DataType.Float2 },
                { name: 'a_texCoord', type: exports.DataType.Float2 },
            ],
...
})(exports.RenderStage || (exports.RenderStage = {}));
let module$1 = null;
...
exports.SpineController = SpineController;
...
exports.addStartupSystem = addStartupSystem;
exports.addSystem = addSystem;
exports.addSystemToSchedule = addSystemToSchedule;
exports.assetPlugin = assetPlugin;
exports.clearDrawCallbacks = clearDrawCallbacks;
exports.clearUserComponents = clearUserComponents;
exports.color = color;
exports.createSpineController = createSpineController;
...
exports.flushPendingSystems = flushPendingSystems;
...
exports.initDrawAPI = initDrawAPI;
exports.initGeometryAPI = initGeometryAPI;
exports.initMaterialAPI = initMaterialAPI;
exports.initPostProcessAPI = initPostProcessAPI;
exports.initRendererAPI = initRendererAPI;
exports.isBuiltinComponent = isBuiltinComponent;
exports.isEditor = isEditor;
exports.isPlatformInitialized = isPlatformInitialized;
exports.isRuntime = isRuntime;
exports.isTextureRef = isTextureRef;
...
exports.quat = quat;
exports.registerDrawCallback = registerDrawCallback;
exports.registerMaterialCallback = registerMaterialCallback;
exports.setEditorMode = setEditorMode;
exports.shutdownDrawAPI = shutdownDrawAPI;
exports.shutdownGeometryAPI = shutdownGeometryAPI;
exports.shutdownMaterialAPI = shutdownMaterialAPI;
exports.shutdownPostProcessAPI = shutdownPostProcessAPI;
exports.shutdownRendererAPI = shutdownRendererAPI;
exports.textPlugin = textPlugin;
exports.unregisterDrawCallback = unregisterDrawCallback;
...
//# sourceMappingURL=index.wechat.cjs.js.map
