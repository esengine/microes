---
title: 简介
description: 了解 Estella 是什么以及为什么选择它
---

Estella 是一个轻量级 2D 游戏引擎，提供 **TypeScript SDK**，后端由 **C++/WebAssembly** 驱动。它附带可视化编辑器用于场景编辑和项目管理，输出可运行在 Web 浏览器和微信小游戏上的游戏。
...
```typescript
import { defineComponent, defineSystem, addSystem, Query, Res, Time, Mut, Transform } from 'esengine';
...
1. [安装编辑器](/docs/zh/getting-started/installation/)
2. [创建你的第一个游戏](/docs/zh/getting-started/quick-start/)
3. [了解 ECS](/docs/zh/core-concepts/ecs/)
