---
title: 编辑器扩展
description: 通过自定义菜单、面板、Gizmo 和设置扩展 Estella 编辑器
---
...
- [自定义绘制](/docs/zh/guides/custom-draw/) — 扩展叠加层的 Draw API
- [材质与着色器](/docs/zh/guides/materials/) — 自定义 Gizmo 的着色器创建
- [后处理效果](/docs/zh/guides/post-processing/) — 从扩展添加后处理 Pass
