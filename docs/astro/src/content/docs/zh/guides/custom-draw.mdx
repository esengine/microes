---
title: 自定义绘制
description: Estella 即时模式 2D 绘图 API，用于调试可视化和动态图形
---
...
使用[场景管理器](/docs/zh/guides/scenes/#场景管理器)时，通过 `SceneContext` 注册绘制回调，自动将其作用域限定到场景。回调仅在场景激活时执行，场景卸载时自动清理：
...
也可以直接向 `registerDrawCallback` 传递场景名：
...
参见[几何体与网格](/docs/zh/guides/geometry/)了解自定义网格创建，以及[材质与着色器](/docs/zh/guides/materials/)了解着色器设置。
...
- [后处理效果](/docs/zh/guides/post-processing/) — 全屏效果管线
- [几何体与网格](/docs/zh/guides/geometry/) — 自定义网格创建
- [材质与着色器](/docs/zh/guides/materials/) — 着色器和材质管理
