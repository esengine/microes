---
title: 后处理效果
description: Estella 逐相机后处理效果管线
---
...
参见[材质与着色器](/docs/zh/guides/materials/)了解更多着色器编写方法。
...
- [自定义绘制](/docs/zh/guides/custom-draw/) — 即时模式绘图图元
- [材质与着色器](/docs/zh/guides/materials/) — 着色器创建和 uniform
