---
title: 渲染纹理
description: 在 Estella 中使用 RenderTexture 进行离屏渲染
---
...
- [自定义绘制](/docs/zh/guides/custom-draw/) — 即时模式绘制 API
- [后处理效果](/docs/zh/guides/post-processing/) — 全屏效果
- [材质与着色器](/docs/zh/guides/materials/) — 自定义着色器
