---
title: UI 构建器
description: ESEngine 中的声明式 UI 构建 API
---
...
<Aside type="tip">
  UI 构建器用于**运行时代码创建 UI**。可视化编辑器设计 UI 请参见 [UI 布局](/microes/zh/guides/ui/)。
</Aside>
...
- [UI 布局](/microes/zh/guides/ui/) — 基于锚点的 UIRect 布局
- [UI 控件](/microes/zh/guides/ui-widgets/) — 组件级控件参考
- [UI 交互](/microes/zh/guides/ui-interaction/) — 事件和回调
