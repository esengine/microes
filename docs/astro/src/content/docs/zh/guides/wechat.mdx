---
title: 微信小游戏
description: 构建和部署 Estella 游戏到微信小游戏平台
---
...
详见[构建流水线 > 资源构建变换](/docs/zh/guides/building/#5-资源构建变换)。
...
- [构建与导出](/docs/zh/guides/building/) -- 构建流水线概览
- [可玩广告](/docs/zh/guides/playable-ads/) -- 用于广告网络的单文件 HTML 构建
- [资源加载](/docs/zh/guides/assets/) -- 资源加载 API
