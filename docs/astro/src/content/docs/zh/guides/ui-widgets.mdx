---
title: UI 控件
description: Estella 中的按钮、滑块、开关、下拉框及其他 UI 控件
---

import { Aside } from '@astrojs/starlight/components';

所有控件都需要在同一实体上添加 `Interactable` 和 `UIRect`。交互事件处理详见 [UI 交互](/docs/zh/guides/ui-interaction/)。
...
- [UI 交互](/docs/zh/guides/ui-interaction/) — 指针事件、焦点和拖拽
