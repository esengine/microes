---
title: 输入处理
description: Estella 中的键盘、鼠标和触摸输入
---

import { Aside } from '@astrojs/starlight/components';

Estella 通过 `Input` 资源提供输入处理。`InputPlugin` 由引擎自动注册，绑定 DOM 键盘、鼠标、触摸和滚轮事件。
...
- [UI 交互](/docs/zh/guides/ui-interaction/) — UI 交互事件（点击、悬停、按压）
- [物理](/docs/zh/guides/physics/) — 物理驱动的运动和碰撞
