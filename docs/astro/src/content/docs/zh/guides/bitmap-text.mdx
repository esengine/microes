---
title: 位图文本
description: 在 Estella 中使用预烘焙位图字体图集渲染文字
---
...
- [资源加载](/docs/zh/guides/assets/) — 加载位图字体和其他资源
- [文本与图片](/docs/zh/guides/ui-text/) — Canvas 2D 文本和 UI 布局
- [渲染](/docs/zh/guides/rendering/) — 相机、变换和渲染顺序
- [组件](/docs/zh/core-concepts/components/) — 所有内置组件
