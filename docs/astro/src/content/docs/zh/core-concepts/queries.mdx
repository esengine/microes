---
title: 查询
description: 在 Estella 中按组件查询实体
---
...
详见[变更检测](/docs/zh/core-concepts/change-detection/)了解基于 tick 的追踪机制。
...
- [变更检测](/docs/zh/core-concepts/change-detection/) — 基于 tick 的 Added、Changed、Removed 追踪
- [事件](/docs/zh/core-concepts/events/) — 解耦的系统间通信
- [资源](/docs/zh/core-concepts/resources/) — 全局单例数据如 Time 和 Input
- [组件](/docs/zh/core-concepts/components/) — 所有内置和自定义组件类型
