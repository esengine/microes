---
title: 事件
description: 在 Estella 中系统之间发送和接收消息
---
...
```typescript
import { defineEvent, defineSystem, addSystem, EventWriter, EventReader, GetWorld, Query, Mut, Commands, Sprite, defineComponent, defineTag, type Entity } from 'esengine';
...
- [变更检测](/docs/zh/core-concepts/change-detection/) — 响应组件的添加和修改
- [系统](/docs/zh/core-concepts/systems/) — 系统参数和调度
