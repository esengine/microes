---
title: 变更检测
description: 在 ESEngine 中响应组件的添加、修改和移除
---
...
- [事件](/microes/zh/core-concepts/events/) — 在系统之间发送和接收消息
- [查询](/microes/zh/core-concepts/queries/) — 基本查询过滤和迭代
- [系统](/microes/zh/core-concepts/systems/) — 系统定义和调度
