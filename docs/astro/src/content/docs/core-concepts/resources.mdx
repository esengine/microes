---
title: Resources
description: Global singleton data in Estella
---
...
See [UI Interaction](/docs/guides/ui-interaction/) for the full list of event types and the callback API.
...
- [Systems](/docs/core-concepts/systems/) — how systems use resources and queries
- [Components](/docs/core-concepts/components/) — data attached to entities
