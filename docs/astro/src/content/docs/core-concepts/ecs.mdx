...
description: Understanding the Entity-Component-System pattern in Estella
---
...
See [Components](/docs/core-concepts/components/) for the full API.
...
See [Systems](/docs/core-concepts/systems/) for the full API.
...
See [Systems](/docs/core-concepts/systems/) and [Queries](/docs/core-concepts/queries/) for detailed usage.

## Next Steps

- [Components](/docs/core-concepts/components/) — builtin and custom components
- [Systems](/docs/core-concepts/systems/) — defining and scheduling systems
- [Queries](/docs/core-concepts/queries/) — querying entities
