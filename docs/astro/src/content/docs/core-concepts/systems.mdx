...
See [Events](/microes/core-concepts/events/) for the full API.
...
- [Change Detection](/microes/core-concepts/change-detection/) — reacting to component changes
- [Events](/microes/core-concepts/events/) — decoupled inter-system communication
