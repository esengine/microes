...
description: Reacting to component additions, modifications, and removals in Estella
---
...
- [Events](/docs/core-concepts/events/) — send and receive messages between systems
- [Queries](/docs/core-concepts/queries/) — basic query filters and iteration
- [Systems](/docs/core-concepts/systems/) — system definition and scheduling
