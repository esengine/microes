---
title: Rendering
description: Camera, transform, and render order in Estella
---
...
For detailed guides on specific rendering components, see [Sprite](/docs/guides/sprite/) and [Spine Animation](/docs/guides/spine/).
...
For screen adaptation and resolution scaling, attach a `Canvas` component to the camera entity. See [Canvas & Resolution](/docs/guides/canvas/) for setup and scale modes.
...
- [Canvas & Resolution](/docs/guides/canvas/) — screen adaptation and scale modes
- [Sprite](/docs/guides/sprite/) — sprite rendering and animation
- [Spine Animation](/docs/guides/spine/) — skeletal animation
- [Bitmap Text](/docs/guides/bitmap-text/) — GPU-rendered bitmap font text
- [Custom Draw](/docs/guides/custom-draw/) — immediate-mode drawing for debug visualization and dynamic graphics
- [Post-Processing](/docs/guides/post-processing/) — full-screen effects (blur, vignette, grayscale)
- [Render Texture](/docs/guides/render-texture/) — off-screen rendering for minimaps, mirrors, and effects
- [Geometry & Meshes](/docs/guides/geometry/) — custom mesh creation for advanced rendering
