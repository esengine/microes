...
All colliders share these properties (ChainCollider does not support `density` or `isSensor`):

| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `density` | number | `1.0` | Mass density. Affects total body mass |
| `friction` | number | `0.3` | Surface friction (0 = ice, 1 = rubber). ChainCollider default: `0.6` |
...
| `radius` | number | `0.05` | Corner rounding radius. Creates a rounded rectangle when > 0 |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `radius` | number | `0.25` | Capsule radius in physics units |
