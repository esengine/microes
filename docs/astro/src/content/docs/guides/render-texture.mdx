...
description: Off-screen rendering with RenderTexture in Estella
---
...
| `depth` | `boolean` | `true` | Attach a depth buffer |
...
```typescript
import { RenderTexture, Renderer } from 'esengine';
...
- [Custom Draw](/docs/guides/custom-draw/) — immediate-mode drawing API
- [Post-Processing](/docs/guides/post-processing/) — full-screen effects
- [Materials & Shaders](/docs/guides/materials/) — custom shaders
