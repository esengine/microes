---
title: Bitmap Text
description: Rendering text with pre-baked bitmap font atlases in Estella
---
...
| `enabled` | boolean | `true` | Whether this text is rendered |
...
- [Asset Loading](/docs/guides/assets/) — loading bitmap fonts and other assets
- [Text & Image](/docs/guides/ui-text/) — Canvas 2D text and UI layout
- [Rendering](/docs/guides/rendering/) — camera, transform, and render order
