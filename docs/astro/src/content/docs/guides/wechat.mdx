...
description: Building and deploying Estella games to WeChat MiniGame platform
---
...
See [Build Pipeline > Asset Build Transforms](/docs/guides/building/#5-asset-build-transforms) for details.
...
- [Building & Exporting](/docs/guides/building/) -- build pipeline overview
- [Playable Ads](/docs/guides/playable-ads/) -- single-file HTML builds for ad networks
- [Asset Loading](/docs/guides/assets/) -- asset loading API
