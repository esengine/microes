---
title: UI Builder
description: Declarative UI construction API in ESEngine
---
...
<Aside type="tip">
  The UI builder is for **runtime UI creation from code**. For designing UI in the visual editor, see [UI Layout](/microes/guides/ui/).
</Aside>
...
- [UI Layout](/microes/guides/ui/) — anchor-based layout with UIRect
- [UI Widgets](/microes/guides/ui-widgets/) — component-level widget reference
- [UI Interaction](/microes/guides/ui-interaction/) — events and callbacks
