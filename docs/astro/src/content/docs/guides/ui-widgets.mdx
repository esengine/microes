---
title: UI Widgets
description: Buttons, sliders, toggles, dropdowns, and other UI widgets in Estella
---

import { Aside } from '@astrojs/starlight/components';

All widgets require `Interactable` and `UIRect` on the same entity. See [UI Interaction](/docs/guides/ui-interaction/) for event handling.
...
- [UI Interaction](/docs/guides/ui-interaction/) — pointer events, focus, and drag
