...
description: Extend the Estella editor with custom menus, panels, gizmos, and settings
---
...
<Aside type="tip">
  Use `registerComponentInspector` when you need full control over a component's inspector UI. For simpler cases, consider `registerPropertyEditor` to customize individual property widgets instead.
</Aside>
...
- [Custom Draw](/docs/guides/custom-draw/) — Draw API for extension overlays
- [Materials & Shaders](/docs/guides/materials/) — shader creation for custom gizmos
- [Post-Processing](/docs/guides/post-processing/) — post-process passes from extensions
