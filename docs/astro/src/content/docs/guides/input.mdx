...
ESEngine provides input handling through the `Input` resource. The `InputPlugin` is registered by the engine automatically, binding DOM keyboard, mouse, touch, and scroll events.
...
- [UI Interaction](/microes/guides/ui-interaction/) — UI interaction events (click, hover, press)
