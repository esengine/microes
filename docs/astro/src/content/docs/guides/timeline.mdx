---
title: Timeline
description: Timeline animation system in ESEngine
---
...
- [Tween Animation](/microes/guides/tween/) — code-driven property animation
- [Spine Animation](/microes/guides/spine/) — skeletal animation
- [Sprite Animation](/microes/guides/sprite-animation/) — frame-by-frame sprite animation
