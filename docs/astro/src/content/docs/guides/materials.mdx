...
description: Custom shaders, blend modes, and material management in Estella
---
...
import { Sprite, Material, BlendMode, ShaderSources, Time } from 'esengine';
...
- [Asset Loading](/docs/guides/assets/) — loading materials and shaders from files
- [Sprite](/docs/guides/sprite/) — assigning materials to sprites
- [Rendering Overview](/docs/guides/rendering/) — rendering pipeline
