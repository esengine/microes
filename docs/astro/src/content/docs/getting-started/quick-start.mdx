---
title: Quick Start
description: Create your first Estella game in minutes
---
...
- [Understand the ECS pattern](/docs/core-concepts/ecs/)
- [Learn about components](/docs/core-concepts/components/)
- [Write systems](/docs/core-concepts/systems/)
