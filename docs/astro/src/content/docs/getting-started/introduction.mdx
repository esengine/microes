---
title: Introduction
description: Learn what Estella is and why you might want to use it
---
...
1. [Install the editor](/docs/getting-started/installation/)
2. [Create your first game](/docs/getting-started/quick-start/)
3. [Learn about ECS](/docs/core-concepts/ecs/)
