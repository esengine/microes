---
title: Installation
description: Install the Estella editor and create your first project
---
...
Download the Estella editor from the [releases page](https://github.com/esengine/estella/releases) and install it.
...
Now that your project is ready, [create your first game](/docs/getting-started/quick-start/).
