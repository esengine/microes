...
async function ESEngineModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  return new URL('hello_triangle.wasm', import.meta.url).href;
...
var _es_app_init = Module['_es_app_init'] = makeInvalidEarlyAccess('_es_app_init');
var _free = Module['_free'] = makeInvalidEarlyAccess('_free');
var _malloc = Module['_malloc'] = makeInvalidEarlyAccess('_malloc');
var _es_init = Module['_es_init'] = makeInvalidEarlyAccess('_es_init');
var _es_update = Module['_es_update'] = makeInvalidEarlyAccess('_es_update');
var _es_render = Module['_es_render'] = makeInvalidEarlyAccess('_es_render');
var _es_shutdown = Module['_es_shutdown'] = makeInvalidEarlyAccess('_es_shutdown');
var _es_on_touch = Module['_es_on_touch'] = makeInvalidEarlyAccess('_es_on_touch');
var _es_on_key = Module['_es_on_key'] = makeInvalidEarlyAccess('_es_on_key');
var _es_renderer_clear = Module['_es_renderer_clear'] = makeInvalidEarlyAccess('_es_renderer_clear');
var _es_renderer_begin_scene = Module['_es_renderer_begin_scene'] = makeInvalidEarlyAccess('_es_renderer_begin_scene');
var _es_renderer_end_scene = Module['_es_renderer_end_scene'] = makeInvalidEarlyAccess('_es_renderer_end_scene');
var _es_renderer_draw_quad = Module['_es_renderer_draw_quad'] = makeInvalidEarlyAccess('_es_renderer_draw_quad');
var _es_renderer_draw_quad_textured = Module['_es_renderer_draw_quad_textured'] = makeInvalidEarlyAccess('_es_renderer_draw_quad_textured');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['es_app_init'] != 'undefined', 'missing Wasm export: es_app_init');
  assert(typeof wasmExports['free'] != 'undefined', 'missing Wasm export: free');
  assert(typeof wasmExports['malloc'] != 'undefined', 'missing Wasm export: malloc');
  assert(typeof wasmExports['es_init'] != 'undefined', 'missing Wasm export: es_init');
  assert(typeof wasmExports['es_update'] != 'undefined', 'missing Wasm export: es_update');
  assert(typeof wasmExports['es_render'] != 'undefined', 'missing Wasm export: es_render');
  assert(typeof wasmExports['es_shutdown'] != 'undefined', 'missing Wasm export: es_shutdown');
  assert(typeof wasmExports['es_on_touch'] != 'undefined', 'missing Wasm export: es_on_touch');
  assert(typeof wasmExports['es_on_key'] != 'undefined', 'missing Wasm export: es_on_key');
  assert(typeof wasmExports['es_renderer_clear'] != 'undefined', 'missing Wasm export: es_renderer_clear');
  assert(typeof wasmExports['es_renderer_begin_scene'] != 'undefined', 'missing Wasm export: es_renderer_begin_scene');
  assert(typeof wasmExports['es_renderer_end_scene'] != 'undefined', 'missing Wasm export: es_renderer_end_scene');
  assert(typeof wasmExports['es_renderer_draw_quad'] != 'undefined', 'missing Wasm export: es_renderer_draw_quad');
  assert(typeof wasmExports['es_renderer_draw_quad_textured'] != 'undefined', 'missing Wasm export: es_renderer_draw_quad_textured');
  ...
  _es_app_init = Module['_es_app_init'] = createExportWrapper('es_app_init', 0);
  _free = Module['_free'] = createExportWrapper('free', 1);
  _malloc = Module['_malloc'] = createExportWrapper('malloc', 1);
  _es_init = Module['_es_init'] = createExportWrapper('es_init', 2);
  _es_update = Module['_es_update'] = createExportWrapper('es_update', 1);
  _es_render = Module['_es_render'] = createExportWrapper('es_render', 0);
  _es_shutdown = Module['_es_shutdown'] = createExportWrapper('es_shutdown', 0);
  _es_on_touch = Module['_es_on_touch'] = createExportWrapper('es_on_touch', 3);
  _es_on_key = Module['_es_on_key'] = createExportWrapper('es_on_key', 2);
  _es_renderer_clear = Module['_es_renderer_clear'] = createExportWrapper('es_renderer_clear', 4);
  _es_renderer_begin_scene = Module['_es_renderer_begin_scene'] = createExportWrapper('es_renderer_begin_scene', 1);
  _es_renderer_end_scene = Module['_es_renderer_end_scene'] = createExportWrapper('es_renderer_end_scene', 0);
  _es_renderer_draw_quad = Module['_es_renderer_draw_quad'] = createExportWrapper('es_renderer_draw_quad', 8);
  _es_renderer_draw_quad_textured = Module['_es_renderer_draw_quad_textured'] = createExportWrapper('es_renderer_draw_quad_textured', 9);
