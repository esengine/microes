...
void NewProjectDialog::setupUI() {
    ...
    dialogPanel->setBackgroundColor(glm::vec4(0.2f, 0.2f, 0.2f, 1.0f));
    dialogPanel->setCornerRadii(ui::CornerRadii::all(8.0f));
    dialogPanel->setWidth(ui::SizeValue::px(450.0f));
    dialogPanel->setHeight(ui::SizeValue::px(280.0f));

    auto layout = makeUnique<ui::StackLayout>(ui::StackDirection::Vertical, 16.0f);
    dialogPanel->setLayout(std::move(layout));
    dialogPanel->setPadding(ui::Insets(24.0f, 24.0f, 24.0f, 24.0f));

    auto titleLabel = makeUnique<ui::Label>(ui::WidgetId(getId().path + ".title"), "New Project");
    ...
    nameLabel->setColor(glm::vec4(0.8f, 0.8f, 0.8f, 1.0f));
    ...
    nameField->setHeight(ui::SizeValue::px(36.0f));
    ...
    pathLabel->setColor(glm::vec4(0.8f, 0.8f, 0.8f, 1.0f));
    ...
    pathRow->setHeight(ui::SizeValue::px(36.0f));
    ...
    pathField->setHeight(ui::SizeValue::px(36.0f));
    ...
    browseButton->setWidth(ui::SizeValue::px(80.0f));
    browseButton->setHeight(ui::SizeValue::px(36.0f));
    ...
    auto spacer = makeUnique<ui::Panel>(ui::WidgetId(getId().path + ".spacer"));
    spacer->setHeight(ui::SizeValue::px(16.0f));
    dialogPanel->addChild(std::move(spacer));
    ...
    cancelButton->setWidth(ui::SizeValue::px(100.0f));
    cancelButton->setHeight(ui::SizeValue::px(40.0f));
    ...
    auto createButton = makeUnique<ui::Button>(ui::WidgetId(getId().path + ".create"), "Create");
    createButton->setButtonStyle(ui::ButtonStyle::Primary);
    createButton->setWidth(ui::SizeValue::px(100.0f));
    createButton->setHeight(ui::SizeValue::px(40.0f));
...
void NewProjectDialog::layout(const ui::Rect& bounds) {
    ...
    if (dialogPanel_) {
        f32 dialogWidth = 450.0f;
        f32 dialogHeight = 280.0f;
